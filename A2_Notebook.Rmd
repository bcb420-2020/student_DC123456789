...
Sample names were mapped to the two most important factors (infection agent and cell type). Given the inconsistent nature of the naming scheme (e.g. infection agent and cell type not in a consistent order, cell type not always explictly listed), a number of different manipulations were required. <br><br>
...
upregulated_genes <- output_hits[output_hits$P.Value < 0.05 & output_hits$logFC > 0, ]
...
downregulated_genes <- output_hits[output_hits$P.Value < 0.05 & output_hits$logFC < 0, ]
